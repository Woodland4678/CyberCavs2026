...
public class RightSideToNeutralTwiceBehindHub extends SequentialCommandGroup {
  ...
  public RightSideToNeutralTwiceBehindHub(CommandSwerveDrivetrain S_Swerve, List<AutoWaypoint[]> waypoints) {
    this.S_Swerve = S_Swerve;
    addRequirements(S_Swerve);
    final List<AutoWaypoint[]> LeftSideGatherFuel1 =
    waypoints.stream()
        .map(segment -> AutoPaths.rotateRedMirrorLeftRight(segment, 16.54))
        .toList();
