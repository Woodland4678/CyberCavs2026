...
public class LeftSideDisturbedMiddlePathOption2ThenDepot extends SequentialCommandGroup {
  ...
  public LeftSideDisturbedMiddlePathOption2ThenDepot(CommandSwerveDrivetrain S_Swerve, Intake S_Intake, Hopper S_Hopper, Shooter S_Shooter, List<AutoWaypoint[]> waypoints) {
