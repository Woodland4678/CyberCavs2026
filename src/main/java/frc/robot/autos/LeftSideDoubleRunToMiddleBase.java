...
public class LeftSideDoubleRunToMiddleBase extends SequentialCommandGroup {
  ...
  public LeftSideDoubleRunToMiddleBase(CommandSwerveDrivetrain S_Swerve, Intake S_Intake, Hopper S_Hopper, Shooter S_Shooter, List<AutoWaypoint[]> waypoints) {
