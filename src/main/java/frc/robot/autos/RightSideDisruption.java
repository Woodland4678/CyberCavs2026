...
public class RightSideDisruption extends SequentialCommandGroup {
  ...
  public RightSideDisruption(CommandSwerveDrivetrain S_Swerve, Intake S_Intake, Hopper S_Hopper, Shooter S_Shooter, List<AutoWaypoint[]> waypoints) {
